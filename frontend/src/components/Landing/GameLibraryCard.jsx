      ...
      >
        ...
        <Skeleton variant="rectangular" width={200} height={100} />
          ...
          <img
            ...
            alt={game?.name}
            style={{ width: 200, height: 100, objectFit: 'cover', borderRadius: '8px' }}
          />
      )}
        </Box>
        ...
        <Box sx={{ display: 'flex', gap: 1, mb: 1 }}>
          ...
          <Box sx={{ display: 'flex', gap: 1, mb: 1 }}>
            {game?.windows && <MicrosoftIcon fontSize="small" color="ashgray" />}
          ...
          {loading ? (
          <Skeleton variant="text" width="50%" height={20} sx={{ display: 'flex', gap: 1, mb: 1 }}/>
        ) : (
          <Box sx={{ display: 'flex', gap: 1, mb: 1 }}>
